...
allProductsAPI = list(Product.objects.values('id', 'name','cost' ,'price', 'slugName', 'imageURL'))
...
def register(request):
    if request.method == 'POST':
        ...
        # Save the user data directly to database
        ...
        return JsonResponse({'success': 'Tài khoản đã được tạo thành công.'}, status=200)
    else:
